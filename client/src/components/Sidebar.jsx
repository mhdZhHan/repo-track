...
const Sidebar = () => {
	...
	return (
		<aside
			className="flex flex-col items-center min-w-12 sm:w-16 h-screen sticky top-0 left-0 py-8 overflow-y-auto border-r bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 
